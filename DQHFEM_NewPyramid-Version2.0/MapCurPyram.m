function [X,Y,Z,dX,dY,dZ,dJ]=MapCurPyram(r,s,t,x,y,z,number)
%UNTITLED2 此处显示有关此函数的摘要
%   此处显示详细说明
if nargin<7
    number.edge=[0,0,0,0,0,0,0,0];
    number.face={[0,0],0,0,0,0};
    number.H=0;
    x=x(1:5);
    y=y(1:5);
    z=z(1:5);
...
if nargout==3
    G=BasePyram(r,s,t,number);
    T=InterpPyram(number,2);
    GG=G*T;
    X=GG*x;
    Y=GG*y;
    Z=GG*z;
